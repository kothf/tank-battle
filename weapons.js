...
const WEAPONS = {
  ...
  nuke: {
    ...
    name: 'Heavy Nuke',
    icon: '☢️',
    desc: 'Heavy thermonuclear payload. Massive crater & high area damage.',
    radius: 50,
    directDmg: 50,
    maxSplashDmg: 35,
    gravityMult: 1.15,
  ...
  mirv: {
    ...
    name: 'MIRV Cluster',
    icon: '💥',
    desc: 'Splits at trajectory apex into 5 spreading bomblets.',
    radius: 20,
    directDmg: 16,
    maxSplashDmg: 12,
    gravityMult: 1.0,
  ...
  drill: {
    ...
    name: 'Tunnel Drill',
    icon: '⛏️',
    desc: 'Subterranean missile. Burrows directly through the ground to strike targets.',
    radius: 30,
    directDmg: 32,
    maxSplashDmg: 20,
    gravityMult: 0.9,
      ...
      if (this.vy >= -0.2 && this.timeAlive >= 14) {
        ...
        for (let i = 0; i < spreads.length; i++) {
          ...
          const sub = new Projectile(
            ...
            this.vx + spX,
            this.vy + spY,
            { ...this.weapon, isMirv: false, radius: 16, directDmg: 14, maxSplashDmg: 10 },
            this.ownerId
          );
